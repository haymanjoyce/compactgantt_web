  ...
  return {
    ...
    config: {
      ...
      bars: {
        ...
        baselineBarHeightFactor:           0.35,
        baselineBarVerticalOffsetFactor:   0,
        baselineMilestoneSizeFactor:       0.4,
        baselineMilestoneVerticalOffsetFactor: 0,
        baselineFillOpacity:               0.4,
      ...
      typography: {
        ...
        pipeAlignmentFactor:          0.7,
        curtainAlignmentFactor:       0.7,
      ...
      rendering: {
        ...
        linkStrokeWidth:            1,
        linkStrokeDasharrayDashed:  '4 3',
        linkCornerRadius:           3,
        insideLabelPadding:         2,
        pipeStrokeWidth:            1,
        pipeStrokeDasharrayDashed:  '4 3',
        pipeStrokeDasharrayDotted:  '1 2',
        pipeBadgePaddingX:          4,
        pipeBadgePaddingY:          2,
        pipeBadgeStrokeWidthFactor: 0.5,
        curtainStrokeWidth:         1,
        curtainBadgePaddingX:       4,
        curtainBadgePaddingY:       2,
        curtainBadgeStrokeWidthFactor: 0.5,
        patternTileSize:            8,
...
function parseWorkbook(workbook) {
  ...
  projectData.config.bars = {
    ...
    baselineBarHeightFactor:           kvFloat(barsKV, 'Baseline Bar Height Factor',           0.35, undefined, cfg('baselineBarHeightFactor')),
    baselineBarVerticalOffsetFactor:   kvFloat(barsKV, 'Baseline Bar Vertical Offset Factor',   0,    undefined, cfg('baselineBarVerticalOffsetFactor')),
    baselineMilestoneSizeFactor:       kvFloat(barsKV, 'Baseline Milestone Size Factor',         0.4,  undefined, cfg('baselineMilestoneSizeFactor')),
    baselineMilestoneVerticalOffsetFactor: kvFloat(barsKV, 'Baseline Milestone Vertical Offset Factor', 0, undefined, cfg('baselineMilestoneVerticalOffsetFactor')),
    baselineFillOpacity:               kvFloat(barsKV, 'Baseline Fill Opacity',                 0.4,  undefined, cfg('baselineFillOpacity')),
  ...
  projectData.config.typography = {
    ...
    pipeAlignmentFactor:          kvFloat(typographyKV, 'Pipe Alignment Factor',            0.7, undefined,                                   cfg('pipeAlignmentFactor')),
    curtainAlignmentFactor:       kvFloat(typographyKV, 'Curtain Alignment Factor',         0.7, undefined,                                   cfg('curtainAlignmentFactor')),
